...
- (void)convert:(NSURL *)inputFile async:(BOOL)async completion:(void (^_Nullable)(NSURL * output))completion;
- (void)convert:(NSURL *)inputFile destination:(NSURL *_Nullable)destination completion:(void (^_Nullable)(NSURL * output))completion;
- (void)convert:(NSURL *)inputFile destination:(NSURL *_Nullable)destination async:(BOOL)async completion:(void (^_Nullable)(NSURL * output))completion;
- (void)convert:(NSURL *)inputFile format:(NSString *_Nullable)format completion:(void (^_Nullable)(NSURL * output))completion;
- (void)convert:(NSURL *)inputFile format:(NSString *_Nullable)format async:(BOOL)async completion:(void (^_Nullable)(NSURL * output))completion;
...
- (void)convert:(NSURL *)inputFile destination:(NSURL *_Nullable)destination format:(NSString *_Nullable)format async:(BOOL)async completion:(void (^_Nullable)(NSURL * output))completion;
- (void)stop;
@end
